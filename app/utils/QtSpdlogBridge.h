...
private:
    ...
    QString formatQtMessage(QtMsgType type, const QMessageLogContext& context,
...
public:
    ...
    void operator()(const QString& format, Args&&... args) {
        m_stream << QString::asprintf(format.toLocal8Bit().constData(),
                                      args...);
    }
...
// macros Use the functions directly: spdlogDebug(), spdlogInfo(), etc.
/*
